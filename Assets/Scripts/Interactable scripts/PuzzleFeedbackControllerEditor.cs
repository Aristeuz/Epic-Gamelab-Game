...
[CustomEditor(typeof(PuzzleFeedbackController))]
public class PuzzleFeedbackControllerEditor : Editor
{
    void OnSceneGUI()
    {
        PuzzleFeedbackController interactable = (PuzzleFeedbackController)target;
